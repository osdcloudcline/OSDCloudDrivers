...
$LGA1851Storage1 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaAHCIC.cat" -IsValid)
$LGA1851Storage2 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaAHCIC.inf" -IsValid)
$LGA1851Storage3 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAC.sys" -IsValid)
$LGA1851Storage4 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorHsaComponent.cat" -IsValid)
$LGA1851Storage5 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorHsaComponent.inf" -IsValid)
$LGA1851Storage6 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorPinningComponent.cat" -IsValid)
$LGA1851Storage7 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorPinningComponent.inf" -IsValid)
$LGA1851Storage8 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAC.cat" -IsValid)
$LGA1851Storage9 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAC.inf" -IsValid)
$LGA1851Storage10 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAC.sys" -IsValid)
$LGA1851Storage11 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAfs.sys" -IsValid)
$LGA1851Storage12 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorVD.cat" -IsValid)
$LGA1851Storage13 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorVD.inf" -IsValid)
$LGA1851Storage14 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorVD.sys" -IsValid)
$LGA1851Storage15 = (Test-Path -Path "C:\OSDCloud\Drivers\Motherboards\ASRock\LGA1851\Storage\IRST\iaStorAfs.sys" -IsValid)

If(($LGA1851Storage1 -eq $true) -and ($LGA1851Storage2 -eq $true) -and ($LGA1851Storage3 -eq $true) -and ($LGA1851Storage4 -eq $true) -and ($LGA1851Storage5 -eq $true) -and ($LGA1851Storage6 -eq $true) -and ($LGA1851Storage7 -eq $true) -and ($LGA1851Storage8 -eq $true) -and ($LGA1851Storage9 -eq $true) -and ($LGA1851Storage10 -eq $true) -and ($LGA1851Storage11 -eq $true) -and ($LGA1851Storage12 -eq $true) -and ($LGA1851Storage13 -eq $true) -and ($LGA1851Storage14 -eq $true) -and ($LGA1851Storage15 -eq $true)){
Write-Verbose "ASRock Socket LGA 1700 Storage drivers have been downloaded and expanded" -Verbose
}
ElseIf (($LGA1851Storage1 -eq $false) -and ($LGA1851Storage2 -eq $false) -and ($LGA1851Storage3 -eq $false) -and ($LGA1851Storage4 -eq $false) -and ($LGA1851Storage5 -eq $false) -and ($LGA1851Storage6 -eq $false) -and ($LGA1851Storage7 -eq $false) -and ($LGA1851Storage8 -eq $false) -and ($LGA1851Storage9 -eq $false) -and ($LGA1851Storage10 -eq $false) -and ($LGA1851Storage11 -eq $false) -and ($LGA1851Storage12 -eq $false) -and ($LGA1851Storage13 -eq $false) -and ($LGA1851Storage14 -eq $false) -and ($LGA1851Storage15 -eq $false)){
$LGA1851Storage = Invoke-WebRequest("https://github.com/osdcloudcline/OSDCloudDrivers/raw/refs/heads/main/Network%20and%20Storage%20/ASRock/Desktops/Intel/LGA%201700/Storage/LGA1851-Storage.ps1")
...
$LGA1851VirtualDrivers = "C:\Logs\OSDCloud\ASRock\LGA1851\Virtual.log"
...
$LGA1851Drivers = "C:\Logs\OSDCloud\ASRock\LGA1851\All-Intel-LGA1851-Motherboards.log"

Start-Transcript -Path $LGA1851Drivers
...
Write-Verbose "Processing: ASRock Intel LGA1851 SteelLegend Motherboard Drivers" -Verbose
Write-Host
...
Write-Verbose "Completed: ASRock Intel LGA1851 Motherboard Driver downloads" -Verbose
Write-Host
