...
$AITOPBluetoothURL = "https://github.com/osdcloudcline/OSDCloudDrivers/raw/refs/heads/main/Network%20and%20Storage%20/Gigabyte/Desktops/AMD/AM5/AI%20TOP/Bluetooth/Gigabyte-AM5-AI%20TOP-BluetoothDrivers.zip"
...
$AITOPDestination = "C:\OSDCloud\Drivers\Motherboards\Gigabyte\AM5\AI-TOP"
...
Write-Verbose "Acquiring Gigabyte AM5 AI TOP Motherboard Bluetooth Drivers from $GHURL" -Verbose
Write-Host

Save-WebFile -SourceUrl  $AITOPBluetoothURL -DestinationDirectory $AITOPDestination
...
Expand-7Zip -ArchiveFileName "$AITOPDestination\Gigabyte-AM5-AI%20TOP-BluetoothDrivers.zip" -TargetPath $AITOPBluetooth  -ErrorAction SilentlyContinue 
