...
Function Show-MainMenu{
   [CmdletBinding()]
   param(
   [string]$Title = 'OSD Cloud ASUS AMD AM4 Desktop Motherboards - Main Menu',
...
Write-Host '        desktop motherboards for the following Gigabyte AMD AM4 model lines:  ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                              ' -BackgroundColor White
...
Write-Host '     - Gigabyte: AMD AM4 Ultra Durable motherboards                           ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host "======= $Title ======"
Write-Host " 1. OSDCloud: AMD AM4 AERO motherboards"
Write-Host " 2. OSDCloud: AMD AM4 AORUS motherboards"
Write-Host " 3. OSDCloud: AMD AM4 Gaming motherboards"
Write-Host " 4. OSDCloud: AMD AM4 Ultra Durable motherboards"
Write-Host " 5. OSDCloud: ALL AMD AM4 motherboards"
...
'4'{cls
    $UltraDurable = Invoke-WebRequest("")
