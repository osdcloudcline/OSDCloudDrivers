...
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath  -ErrorAction SilentlyContinue
...
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet2 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet3 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet4 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet5 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet6 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet7 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet8 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet9 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet10 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet11 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet12 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet13 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet14 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet15 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet16 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet17 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet18 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet19 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet20 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet21 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet22 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet23 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet24 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet25 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet26 -ErrorAction SilentlyContinue
Expand-7zip -ArchiveFileName "$AORUSDestination\" -TargetPath $AORUSEthernet27 -ErrorAction SilentlyContinue
