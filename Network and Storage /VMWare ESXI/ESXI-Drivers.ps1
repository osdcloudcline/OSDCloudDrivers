...
$ESXIPath1 = "C:\Drivers\Virtualization\ESXI\Network"
...
$ESXIDownloadPath1 = "C:\Drivers\Virtualization\ESXI\Download\Network"
...
Expand-7zip -ArchiveFileName "$ESXIDownloadPath1\ESXIDrivers.zip" -TargetPath $ESXIPath1 
...
$ESXIPath2 = "C:\Drivers\Virtualization\ESXI\Storage"
...
$ESXIDownloadPath2 = "C:\Drivers\Virtualization\ESXI\Download\Storage"
...
Expand-7zip -ArchiveFileName "$ESXIDownloadPath2\ESXIDrivers.zip" -TargetPath $ESXIPath2 
