...
Function Show-MainMenu{
   [CmdletBinding()]
   param(
   [string]$Title = 'OSD Cloud ASUS AMD AM5 Desktop Motherboards - Main Menu',
...
Write-Host '     - ASUS: AMD AM5 Other motherboards                                       ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host '     - ASUS: AMD AM5 ROG - Republic of Gamers motherboards                    ' -ForegroundColor DarkBlue -BackgroundColor White
...
Write-Host '     - ASUS: ALL AM5 AM4 motherboards                                         ' -ForegroundColor DarkBlue -BackgroundColor White
Write-Host '                                                                              ' -BackgroundColor White
pause
Clear-Host

Write-Host "======= $Title ======"
Write-Host " 1. OSDCloud: Create ISO - AMD AM5 Business motherboards"
Write-Host " 2. OSDCloud: Create ISO - AMD AM5 CSM motherboards"
Write-Host " 3. OSDCloud: Create ISO - AMD AM5 Other motherboards"
Write-Host " 4. OSDCloud: Create ISO - AMD AM5 PRIME motherboards"
Write-Host " 5. OSDCloud: Create ISO - AMD AM5 ProArt motherboards"
Write-Host " 6. OSDCloud: Create ISO - AMD AM5 ROG - Republic of Gamers motherboards"
Write-Host " 7. OSDCloud: Create ISO - AMD AM5 TUF Gaming motherboards"
Write-Host " 8. OSDCloud: Create ISO - AMD AM5 Expedition motherboards"
Write-Host " 9. OSDCloud: Create ISO - ALL AMD AM5 motherboards"
