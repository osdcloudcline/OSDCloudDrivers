...
$Destination = "C:\OSDCloud\drivers\Chipsets\AM4\ASRock\X570"
...
Expand-Archive -Path "$Destination\AMD_StoreMI.zip" -DestinationPath "C:\OSDCloud\drivers\Chipsets\AM4\ASRock\X570\StoreMI"
