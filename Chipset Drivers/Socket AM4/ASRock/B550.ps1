...
$Destination = "C:\OSDCloud\drivers\Chipsets\AM4\ASRock\B550"
...
Expand-Archive -Path "$Destination\AMD_StoreMI.zip" -DestinationPath "C:\OSDCloud\drivers\Chipsets\AM4\ASRock\B550\StoreMI"
