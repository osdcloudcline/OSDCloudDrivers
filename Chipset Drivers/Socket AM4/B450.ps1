...
$Destination = "C:\OSDCloud\drivers\Chipsets\AM4\B450"
...
Expand-Archive -Path "$Destination\AMD_StoreMI.zip" -DestinationPath "C:\OSDCloud\drivers\Chipsets\AM4\B450\StoreMI"
