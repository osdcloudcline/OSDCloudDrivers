...
$Destination = "C:\OSDCloud\drivers\Chipsets\AM4\A520"
...
Expand-Archive -Path "$Destination\AMD_StoreMI.zip" -DestinationPath "C:\OSDCloud\drivers\Chipsets\AM4\A520\StoreMI"
